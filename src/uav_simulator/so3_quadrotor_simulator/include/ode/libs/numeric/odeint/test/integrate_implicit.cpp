...
struct perform_integrate_const_test {
    void operator()(void)
    {
        ...
        integrate_const(Stepper(), std::make_pair(sys(), jacobi()), x, 0.0,
...
struct perform_integrate_adaptive_test {
    void operator()(void)
    {
        ...
        size_t steps =
            integrate_adaptive(Stepper(), std::make_pair(sys(), jacobi()), x,
                               0.0, t_end, dt, push_back_time(times));
...
struct perform_integrate_n_steps_test {
    void operator()(void)
    {
        ...
        // simple stepper
        value_type end_time =
            integrate_n_steps(Stepper(), std::make_pair(sys(), jacobi()), x,
                              0.0, dt, n, push_back_time(times));
...
class stepper_methods
    : public mpl::vector<
          rosenbrock4<value_type>, rosenbrock4_controller<rosenbrock4<value_type> >,
