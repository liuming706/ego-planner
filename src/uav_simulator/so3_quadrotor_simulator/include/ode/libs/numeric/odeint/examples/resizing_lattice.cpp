...
int main()
{
    ...
    typedef symplectic_rkn_sb3a_mclachlan<coord_type, coord_type, double, coord_type,
                                          coord_type, double, range_algebra,
    ...
    for (int step = 0; step < steps; ++step) {
        ...
        if (distr[10] > 1E-150) {
            ...
            rotate(state.second.begin(), state.second.end() - 20,
                   state.second.end());
