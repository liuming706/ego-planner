...
public:
    ...
    typedef typename fusion::result_of::as_vector<typename mpl::copy<
        stage_indices,
        mpl::inserter<mpl::vector0<>, mpl::push_back<mpl::_1, array_wrapper<double, mpl::_2> > > >::type>::type
        coef_a_type;
    ...
    typedef typename fusion::result_of::as_vector<typename mpl::push_back<
        typename mpl::copy<
            stage_indices,
            mpl::inserter<mpl::vector0<>, mpl::push_back<mpl::_1, stage_wrapper<double, mpl::_2, intermediate_stage> > > >::type,
...
public:
    ...
    {
        fusion::for_each(
            m_stages, calculate_stage<System>(system, x, m_x_tmp, m_F, t, dt));
    }
