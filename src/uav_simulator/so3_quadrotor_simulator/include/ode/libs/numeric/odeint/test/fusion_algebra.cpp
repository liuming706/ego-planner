...
BOOST_AUTO_TEST_CASE(for_each4)
{
    ...
    algebra.for_each4(
        f.res, f.x, f.k1, f.k2,
        default_operations::scale_sum3<value_type, time_type, time_type>(
            1.0, dt, dt));
...
BOOST_AUTO_TEST_CASE(for_each5)
{
    ...
    algebra.for_each5(
        ...
        default_operations::scale_sum4<value_type, time_type, time_type, time_type>(
            1.0, dt, dt, dt));
...
BOOST_AUTO_TEST_CASE(for_each6)
{
    ...
    algebra.for_each6(
        ...
        default_operations::scale_sum5<value_type, time_type, time_type, time_type, time_type>(
            1.0, dt, dt, dt, dt));
...
BOOST_AUTO_TEST_CASE(for_each8)
{
    ...
    algebra.for_each8(
        ...
        default_operations::scale_sum7<value_type, time_type, time_type, time_type,
                                       time_type, time_type, time_type>(
