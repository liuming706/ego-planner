...
public:
    ...
    void do_step(System system, StateInOut &x, const DerivIn &dxdt,
...
BOOST_AUTO_TEST_CASE(test_auto_initialization)
{
    ...
    adams_bashforth<3, state_type, value_type, state_type, value_type, range_algebra,
                    default_operations, initially_resizer, rk4_decorator<state_type> >
        adams;
