...
struct perform_integrate_adaptive_test {
    ...
    {
        std::cout << "Testing integrate_adaptive with "
                  << typeid(Stepper).name() << std::endl;
...
struct perform_integrate_times_test {
    void operator()(const int n = 10, const int dn = 1, const value_type dt = 0.03)
    {
        ...
        // simple stepper
        integrate_times(Stepper(), lorenz, x, obs_times.begin(),
                        obs_times.end(), dt, push_back_time(times, x_end));
...
struct perform_integrate_n_steps_test {
    void operator()(const int n = 200, const value_type dt = 0.01)
    {
        ...
        // simple stepper
        value_type end_time = integrate_n_steps(
            Stepper(), lorenz, x, 0.0, dt, n, push_back_time(times, x_end));
