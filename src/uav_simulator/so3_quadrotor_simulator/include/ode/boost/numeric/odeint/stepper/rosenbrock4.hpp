...
public:
                 ...
                 state_type &xout, time_type dt, state_type &xerr)
    {
        ...
        for (size_t i = 0; i < n; ++i)
            m_g3.m_v[i] =
                m_dxdtnew.m_v[i] + dt * m_coef.d3 * m_dfdt.m_v[i] +
    ...
    void prepare_dense_output()
    {
        ...
        for (size_t i = 0; i < n; ++i) {
            m_cont3.m_v[i] = m_coef.d21 * m_g1.m_v[i] +
                             m_coef.d22 * m_g2.m_v[i] + m_coef.d23 * m_g3.m_v[i] +
                             m_coef.d24 * m_g4.m_v[i] + m_coef.d25 * m_g5.m_v[i];
            m_cont4.m_v[i] = m_coef.d31 * m_g1.m_v[i] +
                             m_coef.d32 * m_g2.m_v[i] + m_coef.d33 * m_g3.m_v[i] +
