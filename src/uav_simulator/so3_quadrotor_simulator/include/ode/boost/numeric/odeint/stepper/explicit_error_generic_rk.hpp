...
template <size_t StageCount, size_t Order, size_t StepperOrder,
          ...
          class Deriv = State, class Time = Value, class Algebra = range_algebra,
...
public:
                      ...
                      time_type t, StateOut &out, time_type dt)
    {
        ...
        m_rk_algorithm.do_step(stepper_base_type::m_algebra, system, in, dxdt,
                               t, out, dt, m_x_tmp.m_v, m_F);
    }
 ...
 * &a , const coef_b_type &b , const coef_b_type &b2 , const coef_c_type &c , const algebra_type &algebra )
...
/**
 * \fn explicit_error_generic_rk::do_step_impl( System system , const StateIn &in
 ...
 * &in , const DerivIn &dxdt , time_type t , StateOut &out , time_type dt ) \brief
