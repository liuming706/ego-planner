...
public:
        ...
        KFAC2(0.9)
    {
        ...
        for (unsigned short i = 0; i < m_k_max + 1; i++) {
            ...
            m_current_k_opt = max BOOST_PREVENT_MACRO_SUBSTITUTION( static_cast<value_type>(
            1 ) , min BOOST_PREVENT_MACRO_SUBSTITUTION( static_cast<value_type>( m_k_max-1 ) , logfact ));
            */
        }
    }
             ...
             time_type &dt)
    {
        ...
        m_dxdt_resizer.adjust_size(
            in, detail::bind(
                    &controlled_error_bs_type::template resize_m_dxdt<StateIn>,
                    detail::ref(*this), detail::_1));
        sys(in, m_dxdt.m_v, t);
...
private:
    ...
    */
    ...
    modified_midpoint<state_type, value_type, deriv_type, time_type,
