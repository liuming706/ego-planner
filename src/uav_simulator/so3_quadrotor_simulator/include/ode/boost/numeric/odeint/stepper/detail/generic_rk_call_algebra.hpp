...
struct generic_rk_call_algebra<4, Algebra> {
    ...
    {
        algebra.for_each5(s1, s2, s4_array[0].m_v, s4_array[1].m_v,
                          s4_array[2].m_v, op);
    }
};
...
struct generic_rk_call_algebra<5, Algebra> {
    ...
    {
        algebra.for_each6(s1, s2, s4_array[0].m_v, s4_array[1].m_v,
                          s4_array[2].m_v, s4_array[3].m_v, op);
    }
};
...
struct generic_rk_call_algebra<6, Algebra> {
    ...
    {
        algebra.for_each7(s1, s2, s4_array[0].m_v, s4_array[1].m_v,
                          s4_array[2].m_v, s4_array[3].m_v, s4_array[4].m_v, op);
    }
};
...
struct generic_rk_call_algebra<8, Algebra> {
    ...
    {
        algebra.for_each9(s1, s2, s4_array[0].m_v, s4_array[1].m_v,
                          s4_array[2].m_v, s4_array[3].m_v, s4_array[4].m_v,
                          s4_array[5].m_v, s4_array[6].m_v, op);
    }
};
