...
# Input variables:
#
# * Eigen_ROOT_DIR (optional): When specified, header files and libraries will
#   be searched for in `${Eigen_ROOT_DIR}/include` and `${Eigen_ROOT_DIR}/libs`
...
#   preference is given to the CMake variable. Use this variable for finding
#   packages installed in a nonstandard location, or for enforcing that one of
#   multiple package installations is picked up.
#
...
# Example usage:
#
# # Passing the version means Eigen_FOUND will only be TRUE if a # version >=
# the provided version is found. find_package(Eigen 3.1.2) if(NOT Eigen_FOUND) #
# Error handling endif() ... add_definitions(${Eigen_DEFINITIONS}) ...
...
find_path(
  ...
  HINTS ${PC_EIGEN_INCLUDEDIR} ${PC_EIGEN_INCLUDE_DIRS} "${Eigen_ROOT_DIR}"
        "$ENV{EIGEN_ROOT_DIR}" "${EIGEN_ROOT}"
        "$ENV{EIGEN_ROOT}" # Backwards Compatibility
